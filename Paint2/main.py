...
brush_tool_img = pygame.image.load('C:\\Users\\malla\\Desktop\\MyProjects\\Paint2\\brush_tool.png')
paint_bucket_tool_img = pygame.image.load('C:\\Users\\malla\\Desktop\\MyProjects\\Paint2\\paint_bucket_tool.png')
eraser_tool_img = pygame.image.load('C:\\Users\\malla\\Desktop\\MyProjects\\Paint2\\eraser_tool.png')
color_picker_tool_img = pygame.image.load('C:\\Users\\malla\\Desktop\\MyProjects\\Paint2\\color_picker_tool.png')
multicolor_img = pygame.image.load('C:\\Users\\malla\\Desktop\\MyProjects\\Paint2\\custom_color_icon.jpg')
check_img = pygame.image.load('C:\\Users\\malla\\Desktop\\MyProjects\\Paint2\\check.png')
...
def canvas():
    ...
    for i in range(length+1):
        ...
        if i == length/2 and mirror:
            pygame.draw.line(screen, (0, 0, 255), (CanvasX+i*10-1, CanvasY), (CanvasX+i*10-1, CanvasY+length*10), 2)
